...
jsPsych.plugins["animation-feedback"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_next_frame() {
      // show image
      display_element.innerHTML = '<img src="'+trial.stimuli[animate_frame]+'" id="jspsych-animation-image" class="center"></img>';
    ...
    var after_response = function(info) {
      ...
      trial.prompt='<p style="font-size:20px; color:green;position:relative;top:0px;">You have responded!</p>';
    }
